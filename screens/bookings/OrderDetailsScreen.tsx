...
import { showBookingConfirmStub } from '@/utils/booking-confirm-actions';
...
export const OrderDetailsScreen = observer(function OrderDetailsScreen() {
  ...
  const showFooter = Boolean(booking);
          ...
          {showFooter ? (
            <StickyBottomOverlay
              ...
              <AppButton
                ...
                onPress={() => showBookingConfirmStub(booking!.status, 'qr')}
                rightIcon="qr-code"
                style={styles.primaryButton}
              />
              <AppButton
                label="Подтвердить по номеру телефона"
                onPress={() => showBookingConfirmStub(booking!.status, 'phone')}
                variant="invisible"
                size="medium"
